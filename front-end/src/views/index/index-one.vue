                    ...
                    <div class="flex items-center justify-between gap-8 flex-col sm:flex-row">
                        <div class="relative z-10 sm:max-w-[632px] w-full slider-content">
                            <div class="flex items-end content-top">
                                <span
                                    class="font-bold text-5xl sm:text-7xl xl:text-9xl text-title leading-none dark:text-white">2025</span>
                                <img class="-ml-5 sm:-ml-10 w-[150px] sm:w-[200px] lg:w-[250px] xl:w-full"
                                     :src="banner3" alt="summer">
                            </div>
                            ...
                            <p class="dark:text-white-light mt-3 md:mt-4 sm:max-w-[450px] xl:max-w-full">Discover the
                                latest must-have arrivals! Elevate your style with our newest collection of trendsetting
                                items. Find your perfect fit with our diverse product. </p>
                ...
                <div class="max-w-[1720px] mx-auto">
                    ...
                    <div class="flex items-center justify-between gap-8 flex-col sm:flex-row">
                        <div class="relative z-10 sm:max-w-[632px] w-full slider-content">
                            ...
                            <p class="dark:text-white-light mt-3 md:mt-4 sm:max-w-[450px] xl:max-w-full">Discover
                                stylish and high-quality furniture to transform your home. Shop from top brands and
                                enjoy exclusive discounts on timeless designs. Elevate your living space today! </p>
                            <div class="button mt-4 md:mt-6">
            ...
            <div class="container-fluid">
                ...
                <div class="max-w-[1720px] mx-auto relative group" data-aos="fade-up" data-aos-delay="100">
                    <swiper
                        ...
                        <swiper-slide v-for="(category, index) in productCategories" :key="index" class="relative block">
                            <img class="w-full object-cover" :src="category.image" alt="Category Image" />
                            <div class="absolute bottom-7 left-0 px-5 transform w-full flex justify-start">
                                <div class="p-[15px] bg-white dark:bg-title w-auto">
                                     <span
                                         class="md:text-xl text-primary font-medium leading-none">{{ category.count }} Items</span>
        ...
        <div class="s-py-50-100">
            <div class="container-fluid">
                <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="leading-none mt-4 md:mt-6 text-2xl md:text-3xl">Nieuwste producten</h3>
                    <p class="mt-3">Be the first to experience innovation with our latest arrivals. Stay ahead of the
                        curve and discover what's new in style, technology, and more. </p>
                </div>
                <div data-aos="fade-up" data-aos-delay="100">
                    <LayoutTwo :collectionId="'pcol_01JQT74FQNAK1ZCA6EC8J8WF6Z'"
                ...
                <div class="text-center mt-7 md:mt-12">
                    <router-link to="/shop-v2" class="btn btn-outline" data-text="All Products">
                ...
                <div class="max-w-[1720px] mx-auto">
                    <div class="max-w-[1186px] ml-auto">
                        ...
                        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-[30px]">
                            <div v-for="(item, index) in featureOne.slice(0,4)" :key="index"
                                 class="why-choose-card p-6 rounded-[10px]" data-aos="fade-up"
        ...
        <div class="s-py-50-100">
            <div class="container-fluid">
                <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="leading-none mt-4 md:mt-6 text-2xl md:text-3xl">Meest verkocht</h3>
                    <p class="mt-3">Be the first to experience innovation with our latest arrivals. Stay ahead of the
                        curve and discover what's new in style, technology, and more. </p>
                </div>
                <div data-aos="fade-up" data-aos-delay="100">
                    <LayoutTwo :collectionId="'pcol_01JQT73CRSFR9M171A8XQQWEYM'"
                               :classList="'max-w-[1720px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8'" />
                </div>
                <div class="text-center mt-7 md:mt-12">
                    <router-link to="/shop-v2" class="btn btn-outline" data-text="All Products">
        ...
        <div class="s-py-50-100">
            <div class="container-fluid">
                <div class="max-w-xl mx-auto mb-8 md:mb-12 text-center" data-aos="fade-up">
                    ...
                    <p class="mt-3">Count on our trusted partnerships to deliver excellence. Collaborating with industry
                        leaders ensures top-quality products and services for your satisfaction. </p>
                </div>
                <div data-aos="fade-up" data-aos-delay="100">
                    <PartnerOne />
                </div>
...
import { getAllProductCategories } from '@/services/medusa';
...
import LayoutTwo from '@/components/product/layout-two.vue';
