<template>
    <div class="inc-dec flex items-center gap-2">
        ...
        <input
            class="w-6 h-auto outline-none bg-transparent text-base md:text-lg leading-none text-title dark:text-white text-center"
            type="text"
            :value="count"
            readonly
        />
...
export default {
    ...
    watch: {
        // 🔁 Watch for external changes to `initial`
        initial(newVal) {
            this.count = newVal;
        }
    },
